...
import aidamaeImage from '../assets/aidamae_delcastillo.jpg';
import joyImage from '../assets/joy_astorga.jpg';
import kristylImage from '../assets/kristyl_ponferrada.jpg';
import aboutBackground from '../assets/capilliaboutpagebg.jpg';
import foundersBg from '../assets/capiilifoundersbg.jpg';
...
function About() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      position: "Chief Commercial Officer",
      description: "I am a Capilli Member.",
      delay: 2200
    }
  ];
  ...
  const awards = [
    {
      ...
      description: "Recognized for innovative business model and impactful sustainable solutions in the Asian entrepreneurship landscape.",
      date: "2022"
    },
    {
      ...
      description: "Acknowledged for exemplary leadership and innovative contributions to sustainable entrepreneurship.",
      date: "2022"
    },
    {
      ...
      description: "Recognized for outstanding achievements in sustainable business innovation and leadership.",
      date: "2023"
    },
    {
      ...
      description: "Honored for excellence in business development and sustainable entrepreneurship.",
      date: "2023"
    },
    {
      ...
      organization: "Local City Government of Iligan, Philippines",
      description: "Recognized for significant contributions to local economic development and innovation.",
      date: "2023"
    },
    {
      image: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=800&auto=format&fit=crop&q=60",
      title: "2023 Recipient of the Oracle Netsuite Social Impact Award Donation",
      organization: "Oracle NetSuite",
      description: "Selected for outstanding social impact and sustainable business practices.",
      date: "2023"
    },
    {
      ...
      description: "Recognized for excellence in sustainable product design and innovation.",
      date: "2024"
    },
    {
      ...
      organization: "Local City Government of Iligan, Philippines",
      description: "Awarded for exceptional entrepreneurial achievement and community impact.",
      date: "2024"
    },
    {
      ...
      organization: "Local City Government of Iligan, Philippines",
      description: "Recognized for effective communication and promotion of sustainable initiatives.",
      date: "2024"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white font-inter">
        ...
        <div className="fade-up max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 hover:shadow-[0_20px_50px_rgba(8,45,15,0.1)] transition-shadow duration-500">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
              Capilli is a Mindanao-based social enterprise start-up that upcycles human waste hair for various industries. Its mission is to create sustainable solutions from human hair waste, making it a pioneer in waste treatment and pollution remediation. Capilli collects human waste hair from salons and barbershops, preventing it from ending up in landfills, and works with a community cooperative of unemployed women and mothers to produce by-products using innovative hair felting technology.
            </p>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Currently, Capilli offers better, cheaper, and more sustainable spill kit alternatives for oil and chemical spills, as well as mats for horticulture and gardening support.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Team Section */}
        <section 
          ...
          style={{
            backgroundImage: `linear-gradient(to bottom, rgba(255, 255, 255, 0.55), rgba(255, 255, 255, 0.95)), url(${foundersBg})`,
      ...
      <section className="py-24 bg-gradient-to-br from-green-50 to-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <pattern id="hairPattern" patternUnits="userSpaceOnUse" width="100" height="100" patternTransform="scale(2) rotate(45)">
              {/* Wavy Hair Strands */}
              <path 
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Revolutionizing hair waste management through innovative solutions and sustainable practices
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 fade-up" style={{ transitionDelay: '200ms' }}>
              <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <h3 className="text-2xl font-bold text-green-800 mb-4">Innovation at Heart</h3>
                <p className="text-gray-600">
                  We're pioneering sustainable solutions in hair waste management, transforming discarded hair into valuable resources through cutting-edge technology and innovative processes.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-800 rounded-xl p-6 text-white shadow-lg transform hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-100">
                  Through our innovative approach, we've successfully diverted tons of hair waste from landfills while creating sustainable products that benefit both the environment and local communities.
                </p>
              </div>
            </div>
          </div>
